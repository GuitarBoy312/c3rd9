...
# 새로운 단어 선택
new_word, new_meaning = random.choice(list(words.items()))

# 이전 단어와 의미 가져오기
word = st.session_state.previous_word
meaning = st.session_state.previous_meaning
...
# 상태 업데이트
st.session_state.previous_word = new_word
st.session_state.previous_meaning = new_meaning
